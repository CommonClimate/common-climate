function wtcsig=wtcsignif_r(mccount,ar1,ts_ref,dt,n,pad,dj,s0,j1,mother,cutoff)
...
% ar1:  AR(1) coefficients for timeseries to be randomized
% ts_ref : reference timeseries
...
for ii=1:mccount
    ...
    [W1,period,scale,coi] = wavelet(d1,dt,pad,dj,s0,j1,mother);
    [W2,period,scale,coi] = wavelet(ts_ref,dt,pad,dj,s0,j1,mother);
